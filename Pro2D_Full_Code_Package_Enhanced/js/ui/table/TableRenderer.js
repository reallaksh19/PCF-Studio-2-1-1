...
export class TableRenderer {
    ...
    render(rows, onCellBlur) {
        ...
        this.tableData = [];
        this._allTableData = [];
        // Do NOT reset this._columnFilters here
        // Filters survive re-render; _applyFilters() is called at the end
        ...
        if (Object.keys(this._columnFilters).length > 0) {
            this._applyFilters();
        }
    ...
    createTableStruct(id, title) {
        ...
        // Group 1: SeqNo Logic (15-22)
        this.addHeaderGroup(trTop, trSub, "SeqNo Logic", 15, 23);

        // Group 2: Final Route (23-26) - 4 Columns
        this.addHeaderGroup(trTop, trSub, "Final Route", 23, 27);

        // Remaining (27+) — Certain columns get a ▼ fill-down button in their header
        const fillDownCols = [
        ...
        for (let i = 0; i < this.headers.length; i++) {
            if (i >= 15 && i < 27) continue; // Skip header groups
