...
const COL = {
  ...
  ca1:  ['CA1', 'CA 1', 'Attr1', 'Attribute1', 'Pressure', 'Des Pr', 'DesignPressure', 'Design Pressure'],
  ca2:  ['CA2', 'CA 2', 'Attr2', 'Attribute2', 'Temperature', 'Des Temp', 'DesignTemp', 'Design Temperature'],
  ca3:  ['CA3', 'CA 3', 'Attr3', 'Attribute3', 'Material', 'MATERIAL'],
  ca4:  ['CA4', 'CA 4', 'Attr4', 'Attribute4', 'Wall Thickness', 'WallThickness', 'Wall_Thickness', 'WallThk'],
  ca5:  ['CA5', 'CA 5', 'Attr5', 'Attribute5', 'Insulation Thickness', 'InsThk', 'Ins Thk'],
  ca6:  ['CA6', 'CA 6', 'Attr6', 'Attribute6', 'Insulation Density', 'InsDen', 'Ins Den'],
  ca7:  ['CA7', 'CA 7', 'Attr7', 'Attribute7', 'Corrosion Allowance', 'CorrAllowance', 'Corr Allow'],
  ca8:  ['CA8', 'CA 8', 'Attr8', 'Attribute8', 'Weight', 'WEIGHT', 'Comp Weight'],
  ca9:  ['CA9', 'CA 9', 'Attr9', 'Attribute9', 'Density', 'Fluid Density', 'FluidDensity'],
  ca10: ['CA10', 'CA 10', 'Attr10', 'Attribute10', 'Hydro Pressure', 'Hydro test pressure', 'HydroPress'],
  // Piping metadata
  ...
  for (const key of groupOrder) {
    ...
    if ((canonType === 'BEND') && ep1 && ep2 && cp) {
      ...
      if (mag1 > 1e-6 && mag2 > 1e-6) {
        ...
        bendAngle = Math.acos(Math.max(-1, Math.min(1, dot))) * (180 / Math.PI);
      }
    }
